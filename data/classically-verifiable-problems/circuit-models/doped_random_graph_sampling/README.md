...
$$ F_1 - F_2 = \frac{\sum_{E \in H \cup L }p(E) f_2(E)}{p_{acc}} -  \frac{\sum_{E \in H \cup L} p(E) f_1(E)}{p_{acc}} = \frac{\sum_{E \in H} p(E)(f_2(E) - f_1(E))}{p_{acc}} + \frac{\sum_{E \in L} p(E)(f_2(E) - f_1(E))}{p_{acc}} $$

Using that $f_1(E) = 1$ for $E \in H$ and $f_1(E) = 0$ for $E \in L$

$$ F_1 - F_2 = \frac{\sum_{E \in H} p(E)(f_2(E) - 1)}{p_{acc}} + \frac{\sum_{E \in L} p(E)f_2(E)}{p_{acc}} \geq -\frac{\sum_{E \in H} p(E)}{p_{acc}} = -Pr(E \in H \|\ E \in A) $$
